...
# Create space between regions in the data for better visualization
region_space = 1
dodge_factor = 0.32
...
# Create box and swarm plots with correct region order
...
# Add horizontal lines to mark world averages
...
# Save plot as an SVG with a transparent background
